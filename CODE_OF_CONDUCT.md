...
OriginOS Toolkit community a harassment-free experience for everyone, regardless of age,
...
- **Encouraging users to void warranty, brick devices, or bypass safety mechanisms to
  "prove" a tweak works.** Testing must be done on your own hardware.
...
maintainers at <https://github.com/cameleonnbss/originos-toolkit/issues> (for non-sensitive
matters) or via a private security advisory for anything sensitive. All complaints will be
